...
int main(){
	...
	while(iterate != NULL){
		Node* adder = nums.tail;
		while(iterate->data + adder->data > 2020){
			adder = adder->prev;
		}
		if(iterate->data + adder->data == 2020){
			cout << "FOUND PAIR!" << endl;
			cout << iterate->data << ", " << adder->data << endl;
			cout << "Multiply = " << iterate->data * adder->data << endl;
			break;
		}
